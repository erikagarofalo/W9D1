...
//----------------------------------------
console.log("\n");
console.log("Esercizio telefono");
console.log("\n");
var utente1 = new User("Erika", "Garofalo");
...
console.log(
  "Il numero delle chiamate effettuate da ".concat(utente1.nome, " ").concat(utente1.cognome, " \u00E8: ").concat(utente1.getNumeroChiamata(), " minuti")
);
// Azzero le chiamate
